...
class Mage_Adminhtml_Block_Sales_Totals extends Mage_Sales_Block_Order_Totals
{
    ...
    protected function _initTotals()
    {
         ...
         * Add Gpay 
         */
		$gpayTotal=$this->getSource()->getGpayTotal();
		if($this->getSource()->getOrderId()) {
			$gpayTotal=$this->getSource()->getOrder()->getGpayTotal();
		}
        $this->_totals['gpay_total'] = new Varien_Object(array(
                'code'      => 'gpay_total',
                'value'     => $gpayTotal,
                'base_value'=> $gpayTotal,
                'label'     => $this->__('Gift pay')
        ));
